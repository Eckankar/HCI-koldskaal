...
$_VIEW["level2Menus"] = array(
  array("url" => "?level1=" . $_GET["level1"] . "&level2=0", "title" => "Undermenu 1"),
  array("url" => "?level1=" . $_GET["level1"] . "&level2=1", "title" => "Undermenu 2"),
  array("url" => "?level1=" . $_GET["level1"] . "&level2=2", "title" => "Undermenu 3"),
);

$_VIEW["level3Menus"] = array(
  array("url" => "?level1=" . $_GET["level1"] . "&level2=" . $_GET["level2"] . "&level3=0", "title" => "Under<sup>2</sup>menu 1"),
  array("url" => "?level1=" . $_GET["level1"] . "&level2=" . $_GET["level2"] . "&level3=1", "title" => "Under<sup>2</sup>menu 2"),
  array("url" => "?level1=" . $_GET["level1"] . "&level2=" . $_GET["level2"] . "&level3=2", "title" => "Under<sup>2</sup>menu 3"),
);
